...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  10.05,  10.05 }
    #define DEFAULT_Ki_LIST {  0.70,  0.70 }
    #define DEFAULT_Kd_LIST { 36.00, 36.00 }
  #else
    #define DEFAULT_Kp  10.05
    #define DEFAULT_Ki   0.70
    #define DEFAULT_Kd  36.00
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 196.52
  #define DEFAULT_bedKi 36.91
  #define DEFAULT_bedKd 261.62
